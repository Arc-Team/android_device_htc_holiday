...
libmm-venc-inc      += device/htc/holiday/legacy/media/mm-core/inc
libmm-venc-inc      += $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
libmm-venc-inc      += device/htc/holiday/legacy/media/libstagefrighthw
libmm-venc-inc      += device/htc/holiday/legacy/display/libgralloc
...
mm-venc-test720p-inc            += device/htc/holiday/legacy/media/mm-core/inc
mm-venc-test720p-inc            += device/htc/holiday/legacy/display/libgralloc
...
venc-test-inc                   += device/htc/holiday/legacy/display/libgralloc

LOCAL_MODULE                    := mm-video-encdrv-test
LOCAL_MODULE_TAGS               := optional
LOCAL_C_INCLUDES                := $(venc-test-inc)
LOCAL_C_INCLUDES                += device/htc/holiday/legacy/media/mm-core/inc
